...
enum AccessibilityPermission {
    ...
    static func notifyMissing() {
        ...
        Mila needs Accessibility permission to paste dictated text into other apps.

        Your transcript is on the clipboard — paste it with ⌘V.

        Grant permission in System Settings → Privacy & Security → Accessibility, then enable Mila. macOS may require you to quit and reopen the app after granting access.
        """
